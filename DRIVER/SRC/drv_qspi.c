...
////////////////////////////////////////////////////////////////////////////////// 	
//文件名：drv_qspi.c
//文件说明：SPI驱动，用来驱动flash
//V1.1 2018.11.3
//GPOIO使用了6个：PB2, PB6, PF6~9							  
////////////////////////////////////////////////////////////////////////////////// 	
...
u8 QSPI_Init(void)
{
    ...
    QSPI_Handler.Init.ClockPrescaler = 3;                     //QPSI分频比，W25Q256最大频率为104M，
    ...
    QSPI_Handler.Init.FlashSize=POSITION_VAL(0X1000000)-1;  //SPI FLASH大小，W25Q256大小为32M字节
